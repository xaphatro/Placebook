 ...
 * <p>
 */
public class SilentGeofenceActivityLogout extends AppCompatActivity implements OnCompleteListener<Void> {

    static SilentGeofenceActivityLogout geoActivity;
    ...
    public void addSilentFences() {
        ...
        ArrayList<List> listHolder = ListController.getAllLists(db.getEmail(), SilentGeofenceActivityLogout.this);
    ...
    public static SilentGeofenceActivityLogout getInstance(){
        return geoActivity;
    }
    ...
    public void onStart() {
        ...
        if (!checkPermissions()) {
            ...
            removeGeofences();//performPendingGeofenceTask();
        }
    }
            ...
            showSnackbar(R.string.permission_rationale, android.R.string.ok,
                    new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            // Request permission
                            ActivityCompat.requestPermissions(SilentGeofenceActivityLogout.this,
